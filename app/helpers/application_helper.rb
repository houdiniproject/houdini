...
module ApplicationHelper
  ...
  # Format date to m/d/Y. Ex: 10/18/2021
  ...
  # Format date with complete month name. Ex: "October 18, 2021"
  def format_date_with_month_name(date_object)
    date_object.strftime('%B %d, %Y')
  end

  # Format date to datetime with timezone. Ex: 10/18/2021 11:00PM (+03:00)
