...
fields.index_definitions(type)

appl.def('custom_fields.definitions.show_modal', function () {
	appl.open_modal('manageFieldDefinitionModal')
})


appl.def('custom_fields.definitions.add', function (form_obj, node) {
	fields.add({ type: type, form_obj: form_obj, node: node })
})


appl.def('custom_fields.definitions.delete', function (name, id, node) {
...
appl.def('custom_fields.bulk.toggle_remove', function (this_field, node) {
	...
	appl.def('custom_fields.definitions.data', appl.custom_fields.definitions.data)
})
...
appl.def('custom_fields.bulk.prepare_to_post', function (form_obj, node) {
	...
	appl.def('custom_fields.definitions.data', appl.custom_fields.definitions.data.map(function (s) { s.remove = false; return s }))
