...
export function readable_date(date?:string, timezone:string='UTC'):string|undefined {
  if(!date) return
...
export function readable_date_time(date?:string, timezone:string='UTC'):string|undefined {
  if(!date) return
...
export class NonprofitTimezonedDates {
  constructor(readonly nonprofitTimezone:string|undefined){

  }

  readable_date(date?:string):string|undefined{
    return readable_date(date, this.nonprofitTimezone || 'UTC')
  }

  readable_date_time(date?:string):string|undefined {
    return readable_date_time(date, this.nonprofitTimezone || 'UTC')
  }

  readable_date_time_to_iso(date?:string):string|undefined {
