...
function LoadReactPage(element:HTMLElement, nonprofit_id:number, dashboard_link:string, payout_link:string) {
  ReactDOM.render(<Root><StripeVerificationConfirm nonprofit_id={nonprofit_id} dashboard_link={dashboard_link} payout_link={payout_link}/></Root>, element)
}
