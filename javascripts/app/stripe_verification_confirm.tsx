...
function LoadReactPage(element:HTMLElement, nonprofit_id:number, dashboard_link:string) {
  ReactDOM.render(<Root><StripeVerificationConfirm nonprofit_id={nonprofit_id} dashboard_link={dashboard_link}/></Root>, element)
}
