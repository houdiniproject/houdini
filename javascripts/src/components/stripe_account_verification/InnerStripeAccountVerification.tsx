      ...
      <div className="container">
        <div className="row">
          <div className={'col-sm-12'}>
            <h1>Verification</h1>
            <p>Stripe, our payment provider, requires every one of their customers to complete a verification process using a secure form. This verification is required by Know Your Customer laws and is standard for all Stripe accounts as well as other payment systems like Paypal. CommitChange <strong>does not</strong> receive your private identifiers like social security numbers or drivers license numbers.</p>
              <ul>
