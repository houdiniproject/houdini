...
function LastStatusUpdate (props:FullStripeVerificationConfirmProps) {
  switch(props.lastStatus){
    case 'completed': {
      return <p> congratulations, you're done!</p>
    }
    case 'needmore': {
      return <>
    ...
    case 'still_pending': {
      return <>
        <p>Stripe is still verifying your information. We'll email you when it's completed</p>
      </>
    }
    case 'unknown_error': {
    ...
    return <div className="tw-bs"><div className="container"><div className="row"><div className={'col-sm-6'}>
       ...
       <div>
        ...
        props.verifying ? 
          ...
          <a href="us.commitchange.com">Return to your dashboard (not recommended)</a>
          </>) :
          (
