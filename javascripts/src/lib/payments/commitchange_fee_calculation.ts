...
interface CFCCConstructorArgs extends ConstructorParameters<typeof CommitchangeStripeFeeStructure> {
  feeCovering?: boolean
  currency: string
}
...
export class CommitchangeFeeCoverageCalculator {
  ...
  constructor(args:CFCCConstructorArgs) {
    this.feeStructure = new CommitchangeStripeFeeStructure(...args as ConstructorParameters<typeof CommitchangeStripeFeeStructure>);
