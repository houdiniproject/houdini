...
describe QuerySupporters do
  ...
  describe ".dupes_on_name_and_phone" do
    ...
    context "when different names" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau", phone: "1234567890")
        force_create(:supporter, nonprofit_id: np.id, name: "Penelope", phone: "(123) 456-7890")
    ...
    context "when different phones" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau", phone: "1234567890")
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau", phone: "1234567891")
    ...
    context "when the name is empty" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "", phone: "1234567890")
        force_create(:supporter, nonprofit_id: np.id, name: "", phone: "(123) 456-7890")
    ...
    context "when the name is nil" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: nil, phone: "1234567890")
        force_create(:supporter, nonprofit_id: np.id, name: nil, phone: "(123) 456-7890")
    ...
    context "when not on strict mode" do
      ...
      context "when the names are not the same" do
        it "does not find" do
          force_create(:supporter, nonprofit_id: np.id, name: "cacau", phone: "1234567890")
          force_create(:supporter, nonprofit_id: np.id, name: "cacau borges", phone: "(123)4567890")
  ...
  describe ".dupes_on_name_and_address" do
    ...
    context "when different names" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau", address: "Clear Waters Avenue")
        force_create(:supporter, nonprofit_id: np.id, name: "Penelope", address: "Clear Waters Avenue")
    ...
    context "when the name is empty" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "", address: "Clear Waters Avenue")
        force_create(:supporter, nonprofit_id: np.id, name: "", address: "Clear Waters Avenue")
    ...
    context "when the name is nil" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: nil, address: "Clear Waters Avenue")
        force_create(:supporter, nonprofit_id: np.id, name: nil, address: "Clear Waters Avenue")
    ...
    context "when not on strict mode" do
      ...
      context "when the names are not the same" do
        it "does not find" do
          force_create(:supporter, nonprofit_id: np.id, name: "cacau", address: "Clear Waters Avenue")
          force_create(:supporter, nonprofit_id: np.id, name: "cacau borges", address: "Clear Waters Avenue")
      ...
      context "when the addresses are not the same" do
        it "does not find" do
          force_create(:supporter, nonprofit_id: np.id, name: "Cacau Borges", address: "Clear Waters Avenue")
          force_create(:supporter, nonprofit_id: np.id, name: "Cacau Borges", address: "Avenue, Clear Waters")
  ...
  describe ".dupes_on_last_name_and_address_and_email" do
    ...
    it "finds supporters with the same last name and address and email" do
      ...
      force_create(:supporter, nonprofit_id: np.id, name: "Penelope Schultz", address: "Clear Waters Avenue", email: "email@example.com")
    ...
    context "when different names" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau Borges", address: "Clear Waters Avenue", email: "email@example.com")
        force_create(:supporter, nonprofit_id: np.id, name: "Penelope Schultz", address: "Clear Waters Avenue", email: "email@example.com")
    ...
    context "when different addresses" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau", address: "Clear Waters Avenue", email: "email@example.com")
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau", address: "Clear.Waters.Avenue")
    ...
    context "when the name is empty" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "", address: "Clear Waters Avenue", email: "email@example.com")
        force_create(:supporter, nonprofit_id: np.id, name: "", address: "Clear Waters Avenue", email: "email@example.com")
    ...
    context "when the name is nil" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: nil, address: "Clear Waters Avenue", email: "email@example.com")
        force_create(:supporter, nonprofit_id: np.id, name: nil, address: "Clear Waters Avenue", email: "email@example.com")
    ...
    context "when not on strict mode" do
      ...
      context "when the addresses are not the same" do
        it "does not find" do
          force_create(:supporter, nonprofit_id: np.id, name: "Cacau Borges", address: "Clear Waters Avenue", email: "email@example.com")
          force_create(:supporter, nonprofit_id: np.id, name: "Cacau Borges", address: "Avenue, Clear Waters", email: "email@example.com")
  ...
  describe ".dupes_on_phone_and_email" do
    ...
    context "when different phones" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, phone: "123456789", email: "cacau@cacau.com")
        force_create(:supporter, nonprofit_id: np.id, phone: "1234567890", email: "cacau@cacau.com")
    ...
    context "when different emails" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, phone: "123456789", email: "cacau@cacau.com")
        force_create(:supporter, nonprofit_id: np.id, phone: "123456789", email: "cacau@gmail.com")
    ...
    context "when the phone is empty" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, phone: "", email: "cacau@cacau.com")
        force_create(:supporter, nonprofit_id: np.id, phone: "", email: "cacau@cacau.com")
    ...
    context "when the phone is nil" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, phone: nil, email: "cacau@cacau.com")
        force_create(:supporter, nonprofit_id: np.id, phone: nil, email: "cacau@cacau.com")
    ...
    context "when the email is empty" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, email: "", phone: "123456789")
        force_create(:supporter, nonprofit_id: np.id, email: "", phone: "123456789")
    ...
    context "when the email is nil" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, email: nil, phone: "123456789")
        force_create(:supporter, nonprofit_id: np.id, email: nil, phone: "123456789")
  ...
  describe ".dupes_on_name_and_email" do
    ...
    context "when different names" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau Borges", email: "cacau@cacau.com")
        force_create(:supporter, nonprofit_id: np.id, name: "Penelope", email: "cacau@cacau.com")
    ...
    context "when different emails" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau Borges", email: "cacau@cacau.com")
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau Borges", email: "cacau@gmail.com")
    ...
    context "when the name is empty" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "", email: "cacau@cacau.com")
        force_create(:supporter, nonprofit_id: np.id, name: "", email: "cacau@cacau.com")
    ...
    context "when the name is nil" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: nil, email: "cacau@cacau.com")
        force_create(:supporter, nonprofit_id: np.id, name: nil, email: "cacau@cacau.com")
    ...
    context "when the email is empty" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, email: "", name: "Cacau Borges")
        force_create(:supporter, nonprofit_id: np.id, email: "", name: "Cacau Borges")
    ...
    context "when the email is nil" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, email: nil, name: "Cacau Borges")
        force_create(:supporter, nonprofit_id: np.id, email: nil, name: "Cacau Borges")
    ...
    context "when not on strict mode" do
      ...
      context "when the name is empty" do
        it "does not find" do
          force_create(:supporter, nonprofit_id: np.id, email: "cacau@gmail.com", name: "")
          force_create(:supporter, nonprofit_id: np.id, email: "cacau@gmail.com", name: "")
      ...
      context "when the name is nil" do
        it "does not find" do
          force_create(:supporter, nonprofit_id: np.id, email: "cacau@gmail.com", name: nil)
          force_create(:supporter, nonprofit_id: np.id, email: "cacau@gmail.com", name: nil)
  ...
  describe ".dupes_on_address" do
    ...
    context "when the address is empty" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau", address: "", zip_code: "32101")
        force_create(:supporter, nonprofit_id: np.id, name: "Penelope", address: "", zip_code: "32101")
    ...
    context "when the address is nil" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau", address: nil, zip_code: "32101")
        force_create(:supporter, nonprofit_id: np.id, name: "Penelope", address: nil, zip_code: "32101")
    ...
    context "when not on strict mode" do
      ...
      context "when the addresses are not the same" do
        it "does not find" do
          force_create(:supporter, nonprofit_id: np.id, name: "Cacau", address: "Clear Waters Avenue", zip_code: "32101")
          force_create(:supporter, nonprofit_id: np.id, name: "Penelope", address: "Clear Waters Avenue 106", zip_code: "32101")
  ...
  describe ".dupes_on_address_without_zip_code" do
    ...
    context "when the address is empty" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau", address: "")
        force_create(:supporter, nonprofit_id: np.id, name: "Penelope", address: "")
    ...
    context "when the address is nil" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau", address: nil)
        force_create(:supporter, nonprofit_id: np.id, name: "Penelope", address: nil)
    ...
    context "when not on strict mode" do
      ...
      context "when the addresses are not the same" do
        it "does not find" do
          force_create(:supporter, nonprofit_id: np.id, name: "Cacau", address: "Clear Waters Avenue")
          force_create(:supporter, nonprofit_id: np.id, name: "Penelope", address: "Clear Waters Avenue 106")
  ...
  describe ".dupes_on_phone_and_email_and_address" do
    ...
    context "when different addresses" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau", phone: "1234567890", email: "cacau@cacau.com", address: "Clear Waters Avenue", zip_code: "32101")
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau", phone: "1234567890", email: "cacau@cacau.com", address: "Clear Waters Park Avenue", zip_code: "32101")
    ...
    context "when different emails" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau", phone: "1234567890", email: "cacau@cacau.com", address: "Clear Waters Avenue", zip_code: "32101")
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau", phone: "1234567890", email: "penelope@penelope.com", address: "Clear Waters Avenue", zip_code: "32101")
    ...
    context "when different zip codes" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau", phone: "1234567890", email: "cacau@cacau.com", address: "Clear Waters Avenue", zip_code: "32101")
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau", phone: "1234567890", email: "cacau@cacau.com", address: "Clear Waters Avenue", zip_code: "32102")
    ...
    context "when different phones" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau", phone: "1234567890", email: "cacau@cacau.com", address: "Clear Waters Avenue", zip_code: "32101")
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau", phone: "1234567891", email: "cacau@cacau.com", address: "Clear Waters Avenue", zip_code: "32101")
    ...
    context "when the phone is empty" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau", phone: "", email: "cacau@cacau.com", address: "Clear Waters Avenue", zip_code: "32101")
        force_create(:supporter, nonprofit_id: np.id, name: "Penelope", phone: "", email: "cacau@cacau.com", address: "Clear Waters Avenue", zip_code: "32101")
    ...
    context "when the phone is nil" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau", email: "cacau@cacau.com", address: "Clear Waters Avenue", zip_code: "32101")
        force_create(:supporter, nonprofit_id: np.id, name: "Penelope", email: "cacau@cacau.com", address: "Clear Waters Avenue", zip_code: "32101")
    ...
    context "when the email is empty" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau", phone: "1234567890", email: "", address: "Clear Waters Avenue", zip_code: "32101")
        force_create(:supporter, nonprofit_id: np.id, name: "Penelope", phone: "1234567890", email: "", address: "Clear Waters Avenue", zip_code: "32101")
    ...
    context "when the email is nil" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau", phone: "1234567890", address: "Clear Waters Avenue", zip_code: "32101")
        force_create(:supporter, nonprofit_id: np.id, name: "Penelope", phone: "1234567890", address: "Clear Waters Avenue", zip_code: "32101")
    ...
    context "when the address is empty" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau", phone: "1234567890", email: "cacau@cacau.com", address: "", zip_code: "32101")
        force_create(:supporter, nonprofit_id: np.id, name: "Penelope", phone: "1234567890", email: "cacau@cacau.com", address: "", zip_code: "32101")
    ...
    context "when the address is nil" do
      it "does not find" do
        force_create(:supporter, nonprofit_id: np.id, name: "Cacau", phone: "1234567890", email: "cacau@cacau.com", zip_code: "32101")
        force_create(:supporter, nonprofit_id: np.id, name: "Penelope", phone: "1234567890", email: "cacau@cacau.com", zip_code: "32101")
    ...
    context "when not on strict mode" do
      ...
      context "when the addresses are not the same" do
        it "does not find" do
          force_create(:supporter, nonprofit_id: np.id, name: "Cacau", phone: "1234567890", email: "cacau@cacau.com", address: "Clear Waters Avenue", zip_code: "32101")
          force_create(:supporter, nonprofit_id: np.id, name: "Penelope", phone: "1234567890", email: "cacau@cacau.com", address: "Clear Waters Avenue - 106", zip_code: "32101")
