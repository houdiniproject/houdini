...
RSpec.describe RecurringDonation, type: :model do
  ...
  describe '#cancel!' do
    ...
    def cancelled_recurring_donation
      ...
      nonprofit = supporter.nonprofit
      donation = create(:donation_base, nonprofit: nonprofit, supporter_id: supporter.id, amount: 999)
      recurring_donation = create(:recurring_donation_base, nonprofit: nonprofit, supporter_id: supporter.id, donation: donation, active:false, 'cancelled_at' => Time.new(2020, 5, 4),
